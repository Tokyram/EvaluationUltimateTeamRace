...
<head>
  ...
  <title>ULTIMATE TEAME RACE</title>
  <!-- loader-->
  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       <img src="<?=base_url('assets/images/house.png')?>" class="logo-icon" alt="logo icon">
       <h5 class="logo-text">ULTIMATE TEAM RACE</h5>
     </a>
   </div>
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="<?=base_url('Controller/liste')?>">
          <i class="zmdi zmdi-invert-colors"></i> <span>Liste des etapes</span>
        </a>
      </li>
      <?php }?>
      ...
      <li>
        <a href="<?=base_url('Controller/profil')?>">
          <i class="zmdi zmdi-face"></i> <span>Profile equipe</span>
        </a>
      </li>
      <?php }?>
      ...
      <?php if(!isset($_SESSION['utilisateur'])) {?>
      <li>
        <a href="<?=base_url('Controller/importation_csv_etape_resultat')?>">
        ...
        </svg>    <span style="margin-left:5px">Import Etapes et Resultat</span>
        </a>
      </li>
      <?php }?>
      ...
      <?php if(!isset($_SESSION['utilisateur'])) {?>
      <li>
        <a href="<?=base_url('Controller/importation_csv_point')?>">
        <svg xmlns="http://www.w3.org/2000/svg"  width="20" height="20" fill="currentColor" class="bi bi-file-earmark-arrow-up-fill" viewBox="0 0 16 16">
          <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M6.354 9.854a.5.5 0 0 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 8.707V12.5a.5.5 0 0 1-1 0V8.707z"/>
        </svg>       <span style="margin-left:5px">Import Points</span>
        </a>
      </li>
      <?php }?>
      ...
      <li>
        <a href="<?=base_url('Controller/categorie_equipe')?>">
        <svg xmlns="http://www.w3.org/2000/svg"  width="20" height="20" fill="currentColor" class="bi bi-file-earmark-arrow-up-fill" viewBox="0 0 16 16">
          <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M6.354 9.854a.5.5 0 0 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 8.707V12.5a.5.5 0 0 1-1 0V8.707z"/>
      ...
      <li>
        <a href="<?=base_url('Controller/deconnexion')?>" target="_blank">
          <i class="icon-power mr-2"></i> <span>Deconnexion</span>
        </a>
      </li>
    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-item"><i class="zmdi zmdi-face"></i> 
            <a href="<?=base_url('Controller/profil')?>" target="_blank">
               Profil
            </a></li>
        <li class="dropdown-divider"></li>
