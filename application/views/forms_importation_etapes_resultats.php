  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      ...
      <div class="col-lg-6">
        ...
        </svg> IMPORTER LES ETAPES ET LES RESULTATS </div>
           <hr>
           <form action="<?= base_url("Controller/importation_csv"); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="input-6">Ajouter votre fichier etapes </label>
                <input type="file" name="csv_file_1" class="form-control form-control-rounded" id="input-6" placeholder="importer le fichier">
            </div>
            <div class="form-group">
                <label for="input-6">Ajouter votre fichier resultats</label>
